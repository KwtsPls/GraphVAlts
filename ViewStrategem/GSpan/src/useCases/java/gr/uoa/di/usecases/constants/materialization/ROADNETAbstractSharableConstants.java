...
public abstract class ROADNETAbstractSharableConstants extends ROADNETAbstractGlobalConstants implements ConstantsSharable {

    private static final String PATTERNS_DATA = "1.roadnetPatterns";
    private static final String GRAPH_GROUPS = "1.roadnetGraphGroups";
    private static final String HIERARCHY_VAULT = "2.roadnet-hierarchyVault.json";
    //
