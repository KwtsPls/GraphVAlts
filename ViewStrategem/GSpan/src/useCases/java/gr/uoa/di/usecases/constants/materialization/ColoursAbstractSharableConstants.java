...
public abstract class ColoursAbstractSharableConstants extends ColoursAbstractGlobalConstants implements ConstantsSharable {

    private static final String PATTERNS_DATA = "1.coloursPatterns";
    private static final String GRAPH_GROUPS = "1.coloursGraphGroups";
    private static final String HIERARCHY_VAULT = "2.colours-hierarchyVault.json";
    //
