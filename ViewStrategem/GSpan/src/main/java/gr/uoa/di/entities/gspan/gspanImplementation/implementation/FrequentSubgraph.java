 ...
 * @author Chao Cheng
 */
class FrequentSubgraph implements Comparable<FrequentSubgraph>{
	
	/** dfs code */
    DFSCode dfsCode;
    
    /** the ids of graphs where the subgraph appears */
    Set<Integer> setOfGraphsIDs;
     ...
     */
    FrequentSubgraph(DFSCode dfsCode, Set<Integer> setOfGraphsIDs, int support){
