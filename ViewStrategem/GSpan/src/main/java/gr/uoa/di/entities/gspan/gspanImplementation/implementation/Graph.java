...
class Graph {
    ...
    private Map<Integer, int[]> mapLabelToVertexIDs;
	 ...
	 */
	void removeInfrequentLabel(int label) {
     ...
     * @param edgeCount 
     */
    Graph(int id, Map<Integer, Vertex> vMap, int multiplicity) {
        this.id = id;
        this.vMap= vMap;
     ...
     */
	void precalculateVertexNeighbors() {
     ...
     */
	void precalculateLabelsToVertices() {
     ...
     */
    int[] findAllWithLabel(int targetLabel) {
     ...
     */
    int getEdgeLabel(int v1, int v2) {
     ...
     */
    boolean isNeighboring(int v1, int v2) {
